...
//     const quoteForms = await addButtonScreen.findAllByRole('form',
// { name: /review quote \d+/i });
...
//     const quoteFormsPlusOne = await addButtonScreen.findAllByRole('form',
// { name: /review quote \d/i });
...
//     const deleteNewQuoteButton = addButtonScreen.getByRole('button',
// { name: /delete review quote 5/i });
...
//     const quoteFormsMinusOne = addButtonScreen.getAllByRole('form',
// { name: /review quote \d/i });
